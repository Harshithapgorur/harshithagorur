...
public class PizzaDTO extends AbstractAuditPizza {
	private String name;
	...
	public PizzaDTO() {
		super();
		System.out.println("calling the deflut cont");
	}

	public PizzaDTO(String createdBy, LocalDateTime createdDate, String updateBy, LocalDateTime updateDate) {
		super(createdBy, createdDate, updateBy, updateDate);
		System.out.println("calling the object from super class");
	}
